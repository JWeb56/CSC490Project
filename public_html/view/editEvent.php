                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item dropdown">
                                <a class="nav-link" href="#pablo" id="navbarDropdownProfile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <p class="h6" style="text-transform: capitalize; display: inline-block"><?php session_start(); echo $_SESSION['user']?>
                                    </p>
                                    </p>
                                </a>
                ...
                <div id="jumbotron" class="jumbotron text-center" style="background-color:grey; box-shadow: 10px 10px 5px black;">
                    ...
                    <form>
                        <div class="input-group">
                            ...
                            <input id="eventName" type="text" class="form-control mt-1" name="categories" placeholder="The name of the event ...">
                        </div>
                        <div class="input-group">
